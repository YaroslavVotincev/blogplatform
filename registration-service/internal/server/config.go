...
type Config struct {
	...
	UserAutoEnable      bool   `config-service:"USER_AUTO_ENABLE"`
	SignupLifetime      int    `config-service:"SIGNUP_LIFETIME"`
	UserCleanupInterval int    `config-service:"USER_CLEANUP_INTERVAL"`
